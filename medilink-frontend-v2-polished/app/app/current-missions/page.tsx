...
function MissionControlPanel({ row, activeSection }: { row: MissionRow; activeSection: MissionSection }) {
  ...
  const detailItems = [
    ...
    { label: 'Logiciel', value: getSoftwareLabel(mission?.softwareUsed || establishment?.softwareUsed) },
        ...
        <div className="candidate-current-tab-panel candidate-current-tab-panel-flat">
          <div className="candidate-current-info">
            ...
            <div>
              ...
              <p>{mission?.equipmentInfo || readableList(mission?.equipmentAvailable, getEquipmentLabel) || 'Matériel à confirmer avant le départ.'}</p>
            </div>
          </div>
