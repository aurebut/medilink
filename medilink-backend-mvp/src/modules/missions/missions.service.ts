  ...
  async create(user: RequestUser, dto: CreateMissionDto) {
    ...
    const mission = await this.prisma.mission.create({
      data: {
        ...
        secretaryType: dto.secretaryType || establishment.secretaryType,
        averagePatientsPerDay: dto.averagePatientsPerDay ?? establishment.averagePatientsPerDay,
        isMultidisciplinary: dto.isMultidisciplinary ?? establishment.isMultidisciplinary,
        equipmentAvailable: dto.equipmentAvailable?.length ? dto.equipmentAvailable : establishment.equipmentAvailable,
